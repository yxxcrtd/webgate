...
public class SystemDaoTestcase extends AbstractJUnit4SpringContextTests {
	...
	public void testGetList() throws Exception {
		...
		List<SysSystem> moduleList = daoFacade.getSystemDao().getList(condition, sort, hqlBean);
		System.out.println("count:" + moduleList.size());
		for(int i = 0; i < moduleList.size(); i ++) {
			SysSystem module = moduleList.get(i);
			System.out.print("【i】:" + i);
			System.out.print("【系统ID】:" + module.getId());
			System.out.print("【系统名称】:" + module.getName());
			System.out.print("【系统编码】:" + module.getCode());
			System.out.print("【系统状态】:" + module.getStatus());
			System.out.println();
		}
		System.out.println("---------------------------------------------------------");
	}
	...
	public void testGetPagingList() throws Exception {
		...
		List<SysSystem> moduleList = daoFacade.getSystemDao().getPagingList(condition, sort, pageCount, countStart, hqlBean);
		System.out.println("count:" + moduleList.size());
		for(int i = 0; i < moduleList.size(); i ++) {
			SysSystem module = moduleList.get(i);
			System.out.print("【i】:" + i);
	...
	public void testGetCount() throws Exception {
		...
		Integer count = daoFacade.getSystemDao().getCount(condition, hqlBean);
